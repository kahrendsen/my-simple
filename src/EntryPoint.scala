object EndlessLoop extends Mootaz {
...
object HelloWorld extends Mootaz {
  def main(args:Array[String]) = {
...
object HelloNumbers extends Mootaz {
  def main(args:Array[String]) = {
...
object HelloName extends Mootaz {
  def main(args:Array[String]) = {
...
object HelloPrint extends Mootaz {
  def main(args:Array[String]) = {
    10 LET ('a := "World")
    20 PRINT "Hello " % 'a
    30 PRINT 'a % " World"
...
object HelloLet extends Mootaz {
  def main(args:Array[String]) = {
...
object SquareRoot extends Mootaz {
  def main(args:Array[String]) = {
...
object Lunar extends Mootaz {
  def main(args:Array[String]) = {
    10 PRINT "Welcome to Mootaz Lunar Lander v0.0.1"
    20 LET ('dist := 100)
    30 LET ('v := 1)
    40 LET ('fuel := 1000)
    50 LET ('mass := 1000)
